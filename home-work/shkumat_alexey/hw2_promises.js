// Выполнение цепочки из функций (две параллельных, затем две последовательных)
// с накопление результатов выполн. каждого шага. В конце выводятся результаты
// выполнения двух последних шагов. Локальные переменные не используются.
